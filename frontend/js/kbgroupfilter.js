...
window.KbGroupFilter = (function () {
    ...
    function injectStyle() {
        ...
        '.kbgf-btn:hover{color:var(--text-primary,#e2e8f0);border-color:rgba(139,92,246,.5);}' +
        '.kbgf-btn .kbgf-badge{font-size:.72rem;font-weight:700;padding:1px 7px;border-radius:999px;' +
            'background:rgba(139,92,246,.22);color:var(--text-primary,#e2e8f0);}' +
        ...
        '.kbgf-a:hover{color:var(--text-primary,#e2e8f0);border-color:rgba(139,92,246,.5);}' +
