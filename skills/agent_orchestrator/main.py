            ...
            "properties": {
                ...
                "task": {
                    ...
                    "description": (
                        ...
                        "FORMATVORGABEN GEHOEREN MIT HINEIN: Aufloesung, "
                        "Seitenverhaeltnis, Seitenzahl, Dateiformat, Sprache. Die "
                        "Rolle sieht die Anfrage des Nutzers nicht – was hier fehlt, "
                        "ist fuer sie nie gesagt worden. 'Erzeuge ein Bild einer Kuh "
                        "in 1536x640' wird also zu einem 'task', der die 1536x640 "
                        "WOERTLICH enthaelt. "
