...
Schwerpunkt: generische Ticket-Arbeit (Suche, Lesen, Anlegen, Kommentieren,
Projekte). Die kundenzentrierten CRM-Auswertungen (Profile, Analyse, Diagramme)
liegen im separaten Kundenverwaltungs-Skill (``skills/kundenverwaltung``).
