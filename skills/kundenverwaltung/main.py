"""Kundenverwaltungs-Skill (CRM-Auswertungen auf Jira-Basis).

Kundenzentrierte Werkzeuge rund um CRM-Organisationen (z.B. 'crm-10550'):
Schlagwort-Ticketlisten, deterministische Kennzahlen-Profile, LLM-gestuetzte
Eskalations-Analyse (Map-Reduce) und fertige Diagramme. 2026-07 aus dem
Jira-Skill herausgeloest; nutzt dieselbe Jira-Verbindung (Konfiguration im
Jira-Skill bzw. Jira-Reiter, inkl. zentraler max_results-Obergrenze).
